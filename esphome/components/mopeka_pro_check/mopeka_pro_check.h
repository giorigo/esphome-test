...
class MopekaProCheck : public Component, public esp32_ble_tracker::ESPBTDeviceListener {
 public:
  ...
  void set_min_signal_quality_to_report(int min);
  ...
  void set_signal_read_quality(sensor::Sensor *rq) { read_quality_ = rq; };
 ...
 protected:
  ...
  SensorReadQuality min_signal_quality_to_report_ = QUALITY_MED;
